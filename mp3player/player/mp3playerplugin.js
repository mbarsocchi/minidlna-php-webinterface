jQuery(document).ready(function($){	
	...
	function Player(playlist){
		...
		this.loadSong = function(index){
			...
			var src = playlist.songs[currentSong].file;
	...
	function initUrl(){
		...
		if(testMp3()){
			url = 'mp3player/player/php/getsongs.php?mp3Player-folder=' +  '&mp3Player-audioType=mp3';
		} else {
			url = 'mp3player/player/php/getoggs.php?mp3Player-folder=' +  '&mp3Player-audioType=ogg';
		}
